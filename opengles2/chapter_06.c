...
draw(void)
{
	...
	glDrawElements(GL_TRIANGLES, sizeof(triangle_indices) / sizeof(triangle_indices[0]), GL_UNSIGNED_SHORT, triangle_indices);
}
...
main(int argc, char *argv[])
{
	...
	glVertexAttribPointer(VERTEX_COLOR_INDEX, VERTEX_COLOR_SIZE, GL_FLOAT, GL_FALSE, sizeof(GLfloat) * (VERTEX_POS_SIZE + VERTEX_COLOR_SIZE), triangle_interleaved_mesh + VERTEX_POS_SIZE);
