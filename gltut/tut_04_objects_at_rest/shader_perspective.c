...
static GLint  sFrustumScaleUniform;
static GLint  sZNearUniform;
static GLint  sZFarUniform;
...
initializeProgram()
{
    ...
    vertexShader = frameworkLoadShader(GL_VERTEX_SHADER, "manual_perspective.vert");
    ...
    sFrustumScaleUniform = glGetUniformLocation(sTheProgram, "u_frustumScale");
    sZFarUniform = glGetUniformLocation(sTheProgram, "u_zFar");
    sZNearUniform = glGetUniformLocation(sTheProgram, "u_zNear");

    glUseProgram(sTheProgram);
    glUniform1f(sFrustumScaleUniform, 1.0f);
    glUniform1f(sZNearUniform, 1.0f);
    glUniform1f(sZFarUniform, 3.0f);
    glUseProgram(0);
