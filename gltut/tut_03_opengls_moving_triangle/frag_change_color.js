...
var FRAGMENT_SHADER_SRC = `#version 100
    ...
    uniform float u_fragLoopDuration;
    ...
    main()
    {
        float currentTime = mod(u_time, u_fragLoopDuration);
        float currentLerp = sin((currentTime / u_fragLoopDuration) * 3.14159);
